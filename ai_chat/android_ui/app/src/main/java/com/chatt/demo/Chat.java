...
//            actionBar.setTitle(buddy.getUsername());
            actionBar.setTitle("AI Alter Ego");
        ...
        try {
            ...
            if(s != null) {
                final Conversation conversation = new Conversation(s,
                        ...
                        "User",
                        "AI Alter Ego",
                        "if_5_smiley_2659946.png");
                conversation.setStatus(Conversation.STATUS_SENDING);
                convList.add(conversation);
                adp.notifyDataSetChanged();

                RequestQueue queue = Volley.newRequestQueue(this);
                String url = "http://35.190.224.20/chatbot/?sentence=" + URLEncoder.encode(s, "UTF-8") + "";
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                final Conversation conversation1 = new Conversation(response,
                                        Calendar.getInstance().getTime(),
                                        "AI Alter Ego",
                                        "User",
                                        "if_5_smiley_2659946.png");
                                conversation.setStatus(Conversation.STATUS_SENT);
                                conversation1.setStatus(Conversation.STATUS_SENT);
                                convList.add(conversation1);
                                adp.notifyDataSetChanged();
                            }
